...
# use like: python tools/midi_to_json.py pack_name
# where pack_name is the folder name inside tools/midi/ which you want to convert.
...
def main(pack_type, pack_name):
    ...
    pack_root_dir = "tools/midi/" + pack_type + '/'
