  ...
  <div class="toolbar">
    ...
    <div class="right">
      ...
      <div class="actions-row">
        <button class="btn icon-btn" disabled={isTransferring} title="Reset device samples to default" aria-label="Reset to default" onclick={uplaodDeviceDefaultSamples}>
